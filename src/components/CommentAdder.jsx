...
const CommentAdder = ({article_id, setComments}) => {
    ...
    const submitHandler = (e) => {
        ...
        api.postComments(article_id, newComment).then((addedComment) => {
  ...
  return (
    <form onSubmit={submitHandler} className='container form__container'>
        ...
        <input id='add-comment' value={newComment} onChange={changeHandler} type='text' placeholder='Add a comment...'></input>
